...
class LunchesControllerTest < ActionController::TestCase
  ...
  test "should create lunch" do
    assert_difference('Lunch.count') do
      post :create, lunch: { calories: @lunch.calories, day: @lunch.day, delicious: @lunch.delicious, food: @lunch.food }
    end
  ...
  test "should update lunch" do
    put :update, id: @lunch, lunch: { calories: @lunch.calories, day: @lunch.day, delicious: @lunch.delicious, food: @lunch.food }
    assert_redirected_to lunch_path(assigns(:lunch))
  end
